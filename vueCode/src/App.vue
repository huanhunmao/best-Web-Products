    ...
    <div id="editor-container" class="editor-container">
      ...
      <header class="header">
        <div class="title-box">
          <div id="title-text" class="title-text">
            <input
              type="text"
              id="title-ipt"
              placeholder="The title of the test is here"
              class="tit-ipt focus"
              style="display: block"
            />
          </div>
        ...
        <div class="action-box">
          <a href="javascript:;" v-on:click="runEditor" class="btn">run</a>

          <a href="javascript:;" v-on:click="clearPen" class="btn"> delete </a>
          <a
            href="javascript:;"
            class="btn view-btn"
            v-on:click="showSettingBox"
          >
            choose view
          </a>
          <a href="javascript:;" v-on:click="setting" class="btn"> setting </a>
          <div
            class="view-box"
            id="view-box"
            v-bind:class="{ active: isShowViewBox }"
          >
            <div class="view-wrap">
              <div class="view-list">
      ...
      <div class="page-wrap" id="page-wrap">
        ...
        <div
          class="bg-mask"
          v-on:click="hideViewBox"
          v-bind:class="{ show: isShowBgMask }"
        ></div>
      </div>
      ...
      <div
        class="setting-box"
        id="settingBox"
        v-bind:class="{ show: isShowSettingBox }"
      >
        <div class="hd">
          <h2>设置</h2>
                ...
                <div class="form-check-inline">
                  <div class="custom-control custom-radio">
                    <input
                      ...
                      v-model="theme"
                    />
                    <label class="custom-control-label" for="themeRadio1"
                      >灰</label
                    >
                  </div>
                </div>
                <div class="form-check-inline">
                  <div class="custom-control custom-radio">
                    <input
                      ...
                      v-model="theme"
                    />
                    <label class="custom-control-label" for="themeRadio2"
                      >黑(推荐护眼)</label
                    >
                  </div>
                </div>
                <div class="form-check-inline">
                  <div class="custom-control custom-radio">
                    <input
                      ...
                      v-model="theme"
                    />
                    <label class="custom-control-label" for="themeRadio3"
                      >深蓝</label
                    >
                  </div>
                </div>
