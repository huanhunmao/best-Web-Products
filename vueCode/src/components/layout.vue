          ...
          <div class="box box-row box-code">
            <div class="boxes boxes-col boxes-col-3" id="boxes-col">
              ...
              <div class="box box-col">
                <div class="box-menu">
                  <div class="editor-actions">
                    <button class="button setting-nub" data-type="css"></button>
              ...
              <div class="box box-col">
                <div class="box-menu">
                  <div class="editor-actions">
                    <button class="button setting-nub" data-type="js"></button>
      ...
      <div class="web-editor web-editor3" data-type="editor3">
        <div class="tab">
          <div class="tab-menus cf" id="tabMenus">
            ...
            <div class="editor-actions">
              <button class="button setting-nub" data-type="tab"></button>
            </div>
          </div>
