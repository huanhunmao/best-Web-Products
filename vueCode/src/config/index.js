...
//Vs Editor Url
config.vsEditorUrl =
  "https://as.alipayobjects.com/g/cicada/monaco-editor-mirror/0.10.1/min";
...
//默认主题
config.defaultTheme = "vs-dark";

//上传配置
config.upload = {
  serverUrl:
    "/cdn/common/ueditor/net/controller.ashx?action=uploadpsd&fileFieldName=file&psd=true&t=",
